...
int main() {
	...
	//initialize the settings for GLFW as version 3.3 and the core profile
	glfwInit();
	...
	//set the vertex position attributes to pointers
	glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 6 * sizeof(float), (void*)0);
	glEnableVertexAttribArray(0);
	//set the vertex color attributes to pointers
